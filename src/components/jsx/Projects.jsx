...
import OctoViewImg from "../../assets/screenshots/octoview.png";
...
const projetos = [
  {
    ...
    descricao:
      "Site de divulgação do Box Maori Cross, localizado em Carpina-PE.",
  ...
  {
    nome: "Octo View",
    url: "https://octoview.netlify.app/",
    descricao:
      "Projeto de estudo com consumo da API Pública do GitHub. Busque por nomes de usuários, repositórios e linha do tempo de usuários do GitHub.",
...

  {
    ...
    descricao:
      "Projeto de estudo com consumo de API Rest oficial da Marvel Comics.",
    tipo: "Projeto de estudo.",
    tecnologias: ["React", "Vite", "TypeScript", "Sass", "API Rest"],
    statusAtual: "Ativo.",
    imagem: NexusImg,
...

  {
    ...
    descricao:
      "Sistema de controle de publicações para contabilidade mensal das Testemunhas de Jeová.",
    tipo: "Projeto voluntário",
...

  {
    ...
    descricao:
      "Site de divulgação dos serviços da Inter@rte - Informática e Gráfica rápida.",
    tipo: "Projeto voluntário",
    tecnologias: ["React", "CSS", "JavaScript"],
    statusAtual: "Em uso.",
    imagem: InterarteImg,
  ...
  },
  {
    ...
    descricao:
      "Site fictício de pedidos de comida online, desenvolvido como projeto de estudo.",
    tipo: "Projeto de estudo",
    tecnologias: ["React", "CSS", "JavaScript"],
    statusAtual: "Ativo",
    imagem: PedeJaImg,
        ...
        {projetos.map((projeto, index) => (
          <div className="bc-project-card" key={index}>
            ...
            <div className="bc-project-info">
              ...
              <p>
                <strong>Status:</strong> {projeto.statusAtual}
              </p>
              <p>
