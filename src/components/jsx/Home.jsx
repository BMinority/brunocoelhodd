    ...
    return (
        <section className='bc-home-container'
            ...
            <header className='bc-home-header'>
                <div className='bc-home-content'>
                    <div className='bc-home-image'>
                        <img src={ImgPerfil} alt="Imagem de Bruno Coelho" />
                    </div>
                    <div className='bc-home-title' id='bc-home-title'>
                        <h1>Designer gráfico e
                            <br />
                            Desenvolvedor web
                        </h1>
                        <p>Com experiência em comércio e administração.</p>
                    </div>

                    <div className='bc-home-text'>
                        <p>Sou um desenvolvedor web e designer gráfico apaixonado por criar experiências visuais impactantes.</p>
                        <a href="#contact" className='bc-home-button'>Entre em contato</a>
                    </div>
                </div>
                ...
                <div className='bc-home-projects-container'>
                    <div className='bc-home-projects'>
                        ...
                        <div className='bc-home-projects-text'>
                            <p>
                                Designer pensado para aumentar a conversão de vendas e melhorar a experiência do usuário.
                            </p>
                        </div>
                    </div>
